...
export class Migrations1741388663219 implements MigrationInterface {
    name = 'Migrations1741388663219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD \`shippingCost\` decimal(10, 2) NOT NULL DEFAULT '0.00'
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD \`additionalInformation\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD \`paymentTransactionId\` varchar(36) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD UNIQUE INDEX \`IDX_20047fb80dc08af215fe46a909\` (\`paymentTransactionId\`)
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            CREATE UNIQUE INDEX \`REL_20047fb80dc08af215fe46a909\` ON \`orders\` (\`paymentTransactionId\`)
        `);
        await queryRunner.query(`
            ALTER TABLE \`auth\`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX \`REL_20047fb80dc08af215fe46a909\` ON \`orders\`
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\` DROP INDEX \`IDX_20047fb80dc08af215fe46a909\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\` DROP COLUMN \`paymentTransactionId\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\` DROP COLUMN \`additionalInformation\`
        `);
        await queryRunner.query(`

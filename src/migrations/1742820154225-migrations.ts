...
export class Migrations1742820154225 implements MigrationInterface {
    name = 'Migrations1742820154225'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ALTER TABLE \`product_variant\`
            ADD \`flavor\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` DROP COLUMN \`imageUrl\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` DROP COLUMN \`flavor\`
        `);
    }

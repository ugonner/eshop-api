...
export class Migrations1744899288312 implements MigrationInterface {
    name = 'Migrations1744899288312'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ALTER TABLE \`product_variant\`
            ADD \`costPrice\` decimal(10, 2) NOT NULL DEFAULT '0.00'
        `);
        await queryRunner.query(`
            ALTER TABLE \`order_item\`
            ADD \`totalCostAmount\` decimal(10, 2) NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD \`totalCostAmount\` decimal(10, 2) NOT NULL DEFAULT '0.00'
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` CHANGE \`flavor\` \`flavor\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` CHANGE \`imageUrl\` \`imageUrl\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` CHANGE \`isDeleted\` \`isDeleted\` tinyint NULL
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`payment_transaction\` CHANGE \`paymentRef\` \`paymentRef\` varchar(255) NULL
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`payment_transaction\` CHANGE \`paymentRef\` \`paymentRef\` varchar(255) NULL DEFAULT 'NULL'
        `);
        await queryRunner.query(`
            ALTER TABLE \`payment_transaction\`
            ADD CONSTRAINT \`FK_c30515be97af9ab6316b00ddeb1\` FOREIGN KEY (\`userId\`) REFERENCES \`profile\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION
        ...
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD \`shippingMethod\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\`
            ADD CONSTRAINT \`FK_151b79a83ba240b0cb31b2302d1\` FOREIGN KEY (\`userId\`) REFERENCES \`profile\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` CHANGE \`isDeleted\` \`isDeleted\` tinyint NULL DEFAULT 'NULL'
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` CHANGE \`imageUrl\` \`imageUrl\` varchar(255) NULL DEFAULT 'NULL'
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` CHANGE \`flavor\` \`flavor\` varchar(255) NULL DEFAULT 'NULL'
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE \`profile\`
            ADD \`address\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`orders\` DROP COLUMN \`totalCostAmount\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`order_item\` DROP COLUMN \`totalCostAmount\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`product_variant\` DROP COLUMN \`costPrice\`
        `);
    }
